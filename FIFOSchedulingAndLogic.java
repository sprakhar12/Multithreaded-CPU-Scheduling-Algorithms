...
public class FIFOSchedulingAndLogic extends Thread {
	...
	//Constructor
	public FIFOSchedulingAndLogic(int[][] cpuqueue, int[][] ioqueue, int process, int process_cycle, int[] sleep, int[][]start_cpu, int[][] end_cpu, 
