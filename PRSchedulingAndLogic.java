...
public class PRSchedulingAndLogic extends Thread {
	...
	//Constructor
	public PRSchedulingAndLogic(List<Integer> sort, int process, int process_cycle, int[] sleep, int[][]start_cpu, int[][] end_cpu, 
